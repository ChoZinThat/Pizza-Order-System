        ...
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a href="" class="text-decoration-none">
                    {{-- <span class="h3 text-uppercase mt-5 text-warning bg-dark px-2">My Shop</span> --}}
                </a>
            </div>
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <span class="h1 text-uppercase text-dark bg-light px-2">Yummy</span>
                        <span class="h1 text-uppercase text-light bg-warning px-2 ml-n1">Pizza</span>
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{route('user#contactPage')}}" class="nav-item nav-link"><i class="fa-solid fa-phone mx-2"></i>Contact</a>
                        </div>
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <div class="dropdown-center d-inline me-5">
                                ...
                                <ul class="dropdown-menu ">
                                    <li><a class="dropdown-item " href="{{route('user#updateProfile')}}"><i class="fa-solid fa-user me-2"></i>Account</a></li>
                                    <li><a class="dropdown-item" href="{{route('user#passwordChangePage')}}"><i class="fa-solid fa-key me-2"></i>Change Password</a></li>
                                    <li>
