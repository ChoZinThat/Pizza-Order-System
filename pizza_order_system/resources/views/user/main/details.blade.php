...
@section('content')
    ...
    <div class="container-fluid pb-3">
        <div class="row px-xl-5">
            <a href="{{route('user#home')}}"><i class="fa-solid fa-arrow-left text-black"></i></a>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    {{-- to get user and product data for oreder --}}
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <button type="button" id="addToCart" class="btn btn-warning px-3"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button>
                    </div>
    ...
    <div class="container-fluid py-5">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-warning pr-3">You May Also Like</span></h2>
        <div class="row px-xl-5">
            <div class="col">
                <div class="owl-carousel related-carousel">
                    ...
                    <div class="product-item bg-light">
                        <div class="product-img position-relative overflow-hidden" >
                            <img class="img-fluid w-100" src="{{ asset('storage/'.$p->image)}}" alt="{{$p->name}}" style="height:250px">
...
@section('scriptSource')
    <script>
        $(document).ready(function(){
            ...
            //when user enter to detail page
            $.ajax({
                type : 'get',
