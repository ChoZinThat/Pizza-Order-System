                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{route('admin#contactList')}}" class="text-decoration-none">
                                <i class="fa-regular fa-envelope"></i>User's message</a>
                        </li>
                    </ul>
                </nav>
            </div>
                                            ...
                                            @if (Auth::user()->image == null)
                                                @if (Auth::user()->gender == 'male')
                                                    <img src="{{ asset('image/default_user.jpg') }}"
                                                        alt={{ Auth::user()->name }} class="rounded-circle img-thumbnail">
                                                @else
                                        ...
                                        <div class="account-dropdown js-dropdown ">
                                                ...
                                                <div class="image">
                                                    <a class="text-decoration-none">
                                                        @if (Auth::user()->image == null)
                                                            ...
                                                            @endif
                                                            <img src="{{ asset('image/default_user.jpg') }}"
                                                                class="rounded-circle img-thumbnail" alt="John Doe" />
                                                        @else
                                                            <img src="{{ asset('storage/' . Auth::user()->image) }}"
                                                                alt={{ Auth::user()->name }}
                                                                class="rounded-circle img-thumbnail" />
                                            ...
                                            <div class="account-dropdown__footer">
                                                <form action="{{ route('logout') }}" method="POST"
                                                    ...
                                                    @csrf
                                                    <button type="submit"
                                                        class="btn btn-outline-dark  col-10 my-3"><i
